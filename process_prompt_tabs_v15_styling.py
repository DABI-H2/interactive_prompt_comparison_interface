...
app.layout = html.Div([
    html.H1("Prompt Comparison Interface", style={
        'text-align': 'center',
        'color': '#4a4a4a',
    ...
    html.Div(
        ...
        children=[
            html.Div(
                style={'flex': '1', 'padding': '10px', 'border': '1px solid #ccc', 'border-radius': '5px', 'margin-right': '10px', 'background-color': '#f9f9f9'},
                children=[
                    dcc.Tabs([
            ...
            html.Div(
                style={'flex': '2', 'padding': '10px', 'border': '1px solid #ccc', 'border-radius': '5px', 'background-color': '#f9f9f9'},
                children=[
                    dcc.Tabs([
                        ...
                        dcc.Tab(label='Summaries Radar Plot', children=[
                            html.Div([
                                html.Label('Select metrics to display:', style={'font-weight': 'bold', 'display': 'block', 'margin-bottom': '10px'}),
                                dcc.Checklist(
                                    id='radar-metrics',
                                    options=[
                                    ...
                                    value=['ROUGE-1', 'ROUGE-L', 'METEOR', 'Cosine'],
